"""Shared path filters for repo-wide scans (wizard, etc.)."""
...
def is_under_archive_dir(rel_posix: str) -> bool:
    ...
    material is ignored by default in wizard scans without requiring every
    consumer repo to list ``**/archive/**`` in YAML.
    """

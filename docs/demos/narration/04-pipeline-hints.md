...
Declarative scene specs mean the model emits YAML rows of boxes. Docgen compiles that into safe Manim layout. If you need custom motion beyond stacked boxes, you fall back to scene-generate and hand-guided Python.
